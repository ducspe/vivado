...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.implementation_options {pipelined_streaming_io} CONFIG.output_ordering {natural_order} CONFIG.run_time_configurable_transform_length {true} CONFIG.target_clock_frequency {100} CONFIG.throttle_scheme {nonrealtime} CONFIG.transform_length {16384}  ] $xfft_0
  ...
  connect_bd_net -net trigger_0_edge [get_bd_pins trigger_0/edge] [get_bd_pins xfft_0/s_axis_config_tvalid]
