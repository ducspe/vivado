...
proc create_root_design { parentCell } {
  ...
  # Create instance: SineWave_Rom_0, and set properties
  set SineWave_Rom_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:SineWave_Rom:1.0 SineWave_Rom_0 ]
  ...
  set_property -dict [ list CONFIG.data_format {fixed_point} CONFIG.implementation_options {pipelined_streaming_io} CONFIG.input_width {16} CONFIG.number_of_stages_using_block_ram_for_data_and_phase_factors {3} CONFIG.output_ordering {bit_reversed_order} CONFIG.target_clock_frequency {100} CONFIG.transform_length {1024}  ] $xfft_0
  ...
  connect_bd_intf_net -intf_net SineWave_Rom_0_M00_AXIS [get_bd_intf_pins SineWave_Rom_0/M00_AXIS] [get_bd_intf_pins xfft_0/S_AXIS_DATA]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins SineWave_Rom_0/m00_axis_aclk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk] [get_bd_pins xfft_0/aclk]
